...
$nome = $_SESSION['dadosUsuario']['cli_nome'];
$cpf = $_SESSION['dadosUsuario']['cli_cpf'];
$email = $_SESSION['dadosUsuario']['cli_email'];
$nomeUsuario = $_SESSION['dadosUsuario']['cli_nome_de_usuario'];
